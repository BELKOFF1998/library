...
Одному автору может сответствовать несколько книг, и у одной книги может быть несколько авторов, по этому связь таблиц книг и авторов имеет вид "многие ко многим" и реализована с помощью вспомогательной таблицы author_book.
##### таблица author_book:
-   id_book – внешний ключ на таблицу book
...
[![N|Solid](https://i.ibb.co/BnpVt55/library-belkov.png)](https://i.ibb.co/BnpVt55/library-belkov.png)
