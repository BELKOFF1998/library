...
--с помощью psql
\copy libraryshema.book (book_name,genre,original_language,pages_number,writing_year) from 'C:\Program Files\PostgreSQL\16\data\book_csv_2.csv' with (format csv, header true, encoding 'UTF-8');
...
server server_csv
options (format 'csv', filename 'book_csv_3.csv', header 'true', encoding 'UTF-8', delimiter ',');
